...
<h2>👩🏻‍💻 Description</h2>
This repository contains scripts that analyze the KEGG gene expression of 3000+ yeast species using ML algorithm Random Forest in R. The objective of this project is to identify the KEGGs that have the highest possiblity of predicting pathogenic yeast using different characteristics such as survival at temperature 37 Celcius and resistance to 9 anti-fungal treatments.
<br />
